  ...
  return (
    <div className="w-full md:w-80 flex flex-col gap-6">
      <div className="bg-blue-50 p-4 rounded-xl flex items-center gap-4">
        <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="avatar" className="w-12 h-12 rounded-full" />
        <div>
          <div className="font-semibold">Did you know?</div>
          <div className="text-sm text-gray-600">
            Shortening your loan term can save you thousands in interest over the life of your mortgage.
          </div>
        </div>
      </div>
      <div className="bg-white p-4 rounded-xl shadow">
        ...
        <div className="font-semibold mb-1">Paid off my home faster!</div>
        <div className="text-sm text-gray-600 mb-2">
          I switched to a 15-year loan and saved a ton on interest. The process was easy and the team was helpful every step of the way.
        </div>
        <div className="flex items-center gap-2">
          <span className="bg-gray-200 rounded-full px-2 py-1 text-xs">LB</span>
          <span className="text-xs text-gray-500">Lisa B</span>
        </div>
      </div>
    </div>
  );
...
export default function ShortenTermCalculationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <h1 className="text-3xl font-bold mb-8 text-center">Shorten Term Calculation</h1>
