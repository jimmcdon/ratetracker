  ...
  return (
    <div className="w-full md:w-80 flex flex-col gap-6">
      <div className="bg-blue-50 p-4 rounded-xl flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-sm text-gray-600">
            Refinancing can lower your monthly payment or help you pay off your loan faster.
          </div>
        </div>
      </div>
      <div className="bg-white p-4 rounded-xl shadow">
        ...
        <div className="font-semibold mb-1">RateTracker made refinancing easy!</div>
        <div className="text-sm text-gray-600 mb-2">
          I was able to lower my payment and save thousands. The process was smooth and transparent. Highly recommend!
        </div>
        <div className="flex items-center gap-2">
          <span className="bg-gray-200 rounded-full px-2 py-1 text-xs">JS</span>
          <span className="text-xs text-gray-500">Jordan S</span>
        </div>
      </div>
    </div>
  );
...
export default function RefinanceCalculationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <h1 className="text-3xl font-bold mb-8 text-center">Refinance Calculation</h1>
