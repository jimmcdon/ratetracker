...
export const Footer: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full bg-gray-50 py-4 text-center text-xs text-gray-400 space-y-1">
        <div>
          <strong>Annual Percentage Rate (APR):</strong> All quoted rates include the Annual Percentage Rate (APR) as required. If an interest rate is mentioned, the APR is disclosed with equal prominence.
        </div>
        <div>
          The payment amount does not include taxes and insurance; the actual payment will be higher.
        </div>
        <div>
          Down payment, repayment terms, and APR are disclosed as required by law. Please review your loan estimate for full details.
        </div>
        <div>
          <strong>Equal Housing Lender</strong>
        </div>
        <div>
          Daniel Dal Porto, President | Broker® | DRE License #01841866 | NMLS License #273255
        </div>
        <div>
          Licensed by the California Department of Real Estate, DRE License #01841866.
        </div>
      </div>
    </>
  )
